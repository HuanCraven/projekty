...
VERSION = "2026.08.19-02"  # při každém buildu zvyš (RRRR.MM.DD-NN)
...
<div id="navod" style="display:none">
  ...
  Ke každému tématu najdeš anotaci, náměty aktivit, napojení na ScioCíle a to,
  jak ho pojmout v různých trojročích. Nemusíš nic instalovat ani se registrovat —
  odkaz si můžeš uložit na plochu telefonu.</p>

  <h3>Záložky nahoře</h3>
  <dl class="nav-dl">
    <dt>Témata</dt><dd>Dlaždice všech 50 témat. Klepnutím na kartu se otevře detail.</dd>
    <dt>Rejstřík kamenů</dt><dd>Obrácený pohled — vyjdeš od stavebního kamene ScioCíle
      a uvidíš, ve kterých tématech se naplňuje. Užitečné, když potřebuješ doložit
      konkrétní kámen.</dd>
    <dt>Hlasování</dt><dd>Výběr témat, která chceš vést, a rezervace.</dd>
  ...
  klidně napiš „konflikt“ nebo „rozpočet“ a uvidíš, kde se to objevuje.
  Diakritiku ani velikost písmen řešit nemusíš.</p>
  ...
  (zkus „Dunbar“ nebo „prokrastinace“).</p>

  <h3>Co najdeš v detailu tématu</h3>
  <dl class="nav-dl">
    <dt>Stěžejní a vedlejší kameny</dt><dd>Rozklikni kámen a uvidíš, co znamená
    ...
    <dt>Náměty aktivit</dt><dd>Pět konkrétních návrhů, co se dá dělat. Není to program,
      ale zásobník — vyber si a doplň svoje.</dd>
    <dt>Tvrdé znalosti</dt><dd>Příklady učiva, které se dá v tématu přirozeně probrat.
      Hodí se, když potřebuješ ukázat, že projekt není „jen zážitek“.</dd>
    ...
    <dt>Klíč <span class="navklic">🔑</span></dt><dd>Metodika Scia k danému kameni:
      ...
      <b>Tyhle texty psala AI a nikdo je nekontroloval</b> — ber je jako dobrý
    ...
    <dt>Přípravy z minulých let</dt><dd>U témat, která už se u nás v nějaké podobě
      dělala, uvidíš složky s loňskými materiály. Samotné soubory jsou na Google Disku.</dd>
  </dl>
  ...
  <ol class="nav-ol">
    <li><b>Napiš si příjmení.</b> Nikde se předem neregistruješ. Kdo přijde po tobě,
      uvidí tvoje jméno v našeptávači — a když ho napíše trochu jinak, appka se zeptá,
      jestli nemyslel tebe. Tím se hlídá, aby z překlepů nevznikli dva lidé.</li>
    <li><b>Vyber až 8 témat</b> v pořadí, jak je chceš. První volba má největší váhu,
      poslední nejmenší. Pořadí měníš šipkami.</li>
    <li><b>Ulož hlasy.</b> Můžeš se kdykoli vrátit a přepsat je — uvidíš svůj poslední
      výběr.</li>
    <li><b>Rezervace</b> je něco jiného než hlas: jedno téma = jeden učitel, platí hned.
      Používej ji, až když je jasno.</li>
  ...
  <p>Katalog není hotová věc. Když v tématu najdeš chybu, chybějící kámen nebo tě
  napadne lepší aktivita, řekni Huanovi — data se dají opravit a web se přegeneruje.
  Totéž platí pro klíče: pokud v nich narazíš na nesmysl, je to očekávatelné
